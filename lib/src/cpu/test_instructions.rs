...
#[test]
fn process_bvc() {
    let mut cpu = build_cpu(0, 0, 0, 0, "v");
...
#[test]
fn process_sed() {
    let mut cpu = build_cpu(0, 0, 0, 0, "D");
...
#[test]
fn process_sei() {
    let mut cpu = build_cpu(0, 0, 0, 0, "I");
