...
mod tests {
    ...
    fn test_immediate_addressing_mode() {
        ...
        assert_eq!(
            value, 0x42,
            "Immediate addressing mode should read the value after PC"
        );
    }
    ...
    fn test_zero_page_x_addressing_mode() {
        ...
        assert_eq!(
            value, 0x37,
            "Value at zero page,X address $45 should be $37"
        );
    }
    ...
    fn test_zero_page_y_addressing_mode() {
        ...
        assert_eq!(
            value, 0x37,
            "Value at zero page,Y address $47 should be $37"
        );
    }
    ...
    fn test_indexed_indirect_addressing_mode() {
        ...
        assert_eq!(
            value, 0x42,
            "Value at indexed indirect address $1234 should be $42"
        );
    }
    ...
    fn test_indexed_indirect_addressing_mode_wrap_around() {
        ...
        assert_eq!(
            addr, 0xABCD,
            "Indexed indirect with wrap-around should point to $ABCD"
        );

        let value = cpu.read_byte_using_mode(AddressingMode::IndexedIndirect);
        assert_eq!(
            value, 0x42,
            "Value at wrapped indexed indirect address $ABCD should be $42"
        );
    }
    ...
    fn test_indirect_indexed_addressing_mode() {
        ...
        assert_eq!(
            value, 0x42,
            "Value at indirect indexed address $1244 should be $42"
        );
    }
    ...
    fn test_indirect_indexed_addressing_mode_page_crossing() {
        ...
        assert_eq!(
            addr, 0x1324,
            "Indirect indexed with page crossing should be $1324"
        );
    ...
    fn test_indirect_indexed_addressing_mode_zero_page_wrap() {
        ...
        assert_eq!(
            addr, 0x1244,
            "Indirect indexed with ZP wrap should be $1244"
        );
    ...
    fn test_crosses_page_boundary() {
        ...
        assert!(
            AddressingMode::AbsoluteX.crosses_page_boundary(&cpu),
        ...
        cpu.write_word(0x0201, 0x12F0);
        assert!(
            AddressingMode::AbsoluteY.crosses_page_boundary(&cpu),
        ...
        assert!(
            AddressingMode::IndirectIndexed.crosses_page_boundary(&cpu),
        ...
        for mode in modes_never_crossing {
            assert!(
                ...
                "Mode {:?} should never cross page boundary",
                mode
            );
        }
    }
